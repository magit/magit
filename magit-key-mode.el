...
(defvar magit-key-mode-groups
  '((dispatch
     (actions
      ...
      ("j" "Jump"            magit-section-jump-map) ; only in status
      ...
      ("s" "Show Status"     magit-status) ; vs. status: magit-state
      ("S" "Stage all"       magit-stage-all)
      ("t" "Tagging"         magit-key-mode-popup-tagging)
      ("U" "Unstage all"     magit-unstage-all)
      ("v" "Show Commit"     magit-show-commit) ; vs. status: magit-revert-item
