...
#+SUBTITLE: for version 2.11.0 (2.11.0-440-g441e33ea8+1)
...
#+TEXINFO: @noindent
This manual is for Magit version 2.11.0 (2.11.0-440-g441e33ea8+1).
...
- User Option: magit-section-initial-visibility-alist
  ...
  The value is an alist.  Each elements maps a section type or lineage
  to the initial visibility state for such sections.  The state has to
  be one of ~show~ or ~hide~, or a function that returns on of these
  symbols.  A function is called with the section as only argument.
