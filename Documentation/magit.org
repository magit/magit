...
- User Option: magit-display-buffer-function
  ...
  functions and then adjust it to your needs.  More functions to
  choose from will likely be added in the future, and eventually the
  default will change.
...
- Function: magit-insert-submodules
  ...
  Insert sections for all modules.  For each section insert the path
  and the output of ~git describe --tags~.
...
- Command: magit-list-repositories
  ...
  This command displays a list of repositories.
...
- User Option: magit-repolist-columns
  ...
  This options controls what columns are displayed by the command
  ...
  the column.  FORMAT is a function.  It is called with one argument
  the repository identification (usually its basename) and with
  ~default-diretory~ bound to the toplevel of its working tree, and has
  to return a string to be inserted or nil.  PROPS is an alist,
  supported keys are ~:right-align~ and ~:pad-right~.

The following functions can be added to the above option:

- Function: magit-repolist-column-ident

  This function insert the identification of the repository.  Usually
...
- Function: magit-repolist-column-unpulled-from-upstream
  ...
  This function inserts number of upstream commits not in the current
  branch.

- Function: magit-repolist-column-unpulled-from-pushremote

  This function inserts number of commits on push branch but not in
  the current branch.

- Function: magit-repolist-column-unpushed-to-upstream

  This function inserts number of commits not in the current branch
...
In this case you have chosen to take the red pill on one bracnh and on
