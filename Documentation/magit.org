...
#+SUBTITLE: for version 2.13.0 (2.13.0-68-gfb5341b38+1)
...
#+TEXINFO: @noindent
This manual is for Magit version 2.13.0 (2.13.0-68-gfb5341b38+1).
...
A few additional commands that operate on a single file exist, that are
not available from the file popup by default:
...
- Command: magit-file-checkout
  ...
  This command update file in the working tree and index to the
