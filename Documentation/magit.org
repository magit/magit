...
#+SUBTITLE: for version 2.13.0 (2.13.0-128-g9c212e8c7+1)
...
#+TEXINFO: @noindent
This manual is for Magit version 2.13.0 (2.13.0-128-g9c212e8c7+1).
...
- User Option: magit-wip-merge-branch
  ...
  wip refs after a new commit was created on the branch.  If non-nil
