...
#+SUBTITLE: for version 2.90.1 (v2.90.1-670-g01efbb2de+1)
...
#+TEXINFO: @noindent
This manual is for Magit version 2.90.1 (v2.90.1-670-g01efbb2de+1).
...
- User Option: magit-status-margin
  ...
  e.g. to enable the "Recent commits" pane, and show the author column in it,
  when you run
...
M-x magit-status RET
  ...
  you can set the following in your ~.emacs~:
  #+BEGIN_SRC emacs-lisp
