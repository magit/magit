...
#+SUBTITLE: for version 2.11.0 (2.11.0-71-g3a0faaf3+1)
...
#+BEGIN_QUOTE
This manual is for Magit version 2.11.0 (2.11.0-71-g3a0faaf3+1).
...
- Key: q, magit-blame-quit
  ...
  during a recursive blame, then it also kill the buffer.
