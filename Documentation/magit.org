...
#+SUBTITLE: for version 2.90.1 (v2.90.1-845-g4b97f23ac+1)
...
#+TEXINFO: @noindent
This manual is for Magit version 2.90.1 (v2.90.1-845-g4b97f23ac+1).
...
course be turned off, but the result of doing that ususally is that
instead of some code its now the human who is reviewing your commits
