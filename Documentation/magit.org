...
#+SUBTITLE: for version 2.13.0 (2.13.0-37-g48000cde+1)
...
#+TEXINFO: @noindent
This manual is for Magit version 2.13.0 (2.13.0-37-g48000cde+1).
...
- User Option: magit-commit-ask-to-stage
  ...
  Whether to ask to stage all unstaged files when committing and nothing is
  staged.
