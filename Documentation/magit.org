...
- Key: L, magit-log-refresh-buffer
...
- Key: +, magit-diff-more-context
  ...
  This command increase the context for diff hunks by COUNT lines.

- Key: 0, magit-diff-default-context

  This command reset context for diff hunks to the default height.
