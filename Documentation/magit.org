...
- User Option: magit-branch-separate-config-popup
  ...
  This option controls whether to put the git variables mentioned
  above into a separate popup.  This options must set to t *before*
  loading magit in order to take effect.
