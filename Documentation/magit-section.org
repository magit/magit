...
#+SUBTITLE: for version 2.90.1 (v2.90.1-996-g6b88fab39+1)
...
#+TEXINFO: @noindent
This manual is for Magit-Section version 2.90.1 (v2.90.1-996-g6b88fab39+1).
...
- Function: magit-insert-section [name] (type &optional value hide) &rest body
  ...
  Like functions and variables, TYPE must be prefixed with the
  package name.  (For historic reasons the types used by Magit
  and Forge do not use a package prefix.)
