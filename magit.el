...
;; Used in `magit-commit-{instant-fixup|instant-squash|async}'
(declare-function magit-rebase-autosquash 'magit-sequence)
(declare-function magit-rebase-in-progress-p 'magit-sequence)
