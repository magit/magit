...
With a prefix argument, visit in other window."
  ...
  (magit-section-action (item info "visit" t)
    ((untracked file) (call-interactively 'magit-visit-file-item))
    ((diff)           (call-interactively 'magit-visit-file-item))
    ((diffstat)       (call-interactively 'magit-visit-file-item))
    ((hunk)           (call-interactively 'magit-visit-file-item))
