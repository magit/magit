...
(defun magit-discard ()
  ...
  (--when-let (magit-current-section)
    (pcase (list (magit-diff-type) (magit-diff-scope))
      ...
      (`(,_    region) (magit-discard-apply it))
      (`(,_      hunk) (magit-discard-apply it))
      (`(,_     hunks) (magit-discard-apply it))
...
(defun magit-reverse (&rest args)
  ...
  (--when-let (magit-current-section)
    (pcase (list (magit-diff-type) (magit-diff-scope))
      ...
      (`(,_    region) (magit-reverse-apply it args))
      (`(,_      hunk) (magit-reverse-apply it args))
      (`(,_     hunks) (magit-reverse-apply it args))
