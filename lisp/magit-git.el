  ...
  (let* ((branch (magit-get-current-branch))
    ...
    (cl-remove-duplicates
     `(("rev-parse" "--verify" "--abbrev-ref" ,(concat main "@{upstream}"))
       ...
       ("rev-parse" "--verify" ,(concat "refs/tags/" branch) :cache-errors)
       ("rev-parse" "--verify" ,(concat "refs/tags/" main) :cache-errors)
       ("rev-parse" "--verify" ,(concat "refs/tags/" push-branch) :cache-errors)
       ("rev-parse" "--verify" ,(concat "refs/tags/" push-main) :cache-errors)
       ("rev-parse" "--verify" ,(format "refs/tags/%s/HEAD" primary-remote) :cache-errors)
       ("rev-parse" "--verify" ,push-branch :cache-errors))
     :test 'equal)))
